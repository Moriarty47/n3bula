...
export const hsl2stringData: { v: HSL, e: string; }[] = transformer<HSL, string>([
  [[0, 0, 0, 1], 'hsla(0,0%,0%,1)'],
  [[0, 0, 100, 1], 'hsla(0,0%,100%,1)'],
  [[14.3, 81.7, 62.4], 'hsl(14,82%,62%)'],
  [[50, 89.3, 49.7, 1], 'hsla(50,89%,50%,1)'],
  [[50.5, 100, 37.5, 1], 'hsla(51,100%,38%,1)'],
  [[61.5, 63.8, 39.3, .3], 'hsla(62,64%,39%,0.3)'],
  [[120, 100, 25, 1], 'hsla(120,100%,25%,1)'],
  [[134.9, 70.7, 39.6, .7], 'hsla(135,71%,40%,0.7)'],
  [[180, 100, 75, 1], 'hsla(180,100%,75%,1)'],
  [[240, 100, 75, 1], 'hsla(240,100%,75%,1)'],
  [[250, 83.2, 51.1, 1], 'hsla(250,83%,51%,1)'],
  [[300, 50, 50], 'hsl(300,50%,50%)'],
], formatters.hsl, formatters.string);
