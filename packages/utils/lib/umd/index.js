...
__webpack_require__.d(__webpack_exports__, {
  ...
  isBrowser: () => (/* reexport */ isBrowser),
  isFunction: () => (/* reexport */ isFunction),
  isInt32: () => (/* reexport */ isInt32),
  isMac: () => (/* reexport */ isMac),
  isMobile: () => (/* reexport */ isMobile),
...
var path_process;
// @ts-ignore
if (typeof path_process === 'undefined') {
  path_process = {
    cwd: function cwd() {
      return '/';
    }
...
function resolve() {
  ...
  for (var i = rest.length - 1; i >= -1 && !resolvedAbsolute; i--) {
    var path_1 = i >= 0 ? rest[i] : path_process.cwd();
    assertPath(path_1);
...
var isBrowser = function isBrowser() {
  var _a;
  return !!(typeof window !== 'undefined' && ((_a = window === null || window === void 0 ? void 0 : window.document) === null || _a === void 0 ? void 0 : _a.createElement));
};
var isNode = function isNode() {
  var _a;
  return !!(typeof window === 'undefined' && typeof process !== 'undefined' && ((_a = process === null || process === void 0 ? void 0 : process.versions) === null || _a === void 0 ? void 0 : _a.node));
};
...
function js_yaml_padStart(string, max) {
...
function makeSnippet(mark, options) {
  ...
  for (i = 1; i <= options.linesBefore; i++) {
    ...
    result = common.repeat(' ', options.indent) + js_yaml_padStart((mark.line - i + 1).toString(), lineNoLength) +
      ' | ' + line.str + '\n' + result;
  }

  line = getLine(mark.buffer, lineStarts[foundLineNo], lineEnds[foundLineNo], mark.position, maxLineLength);
  result += common.repeat(' ', options.indent) + js_yaml_padStart((mark.line + 1).toString(), lineNoLength) +
    ' | ' + line.str + '\n';
...
function js_yaml_isNull(object) {
  return object === null;
}
...
;// CONCATENATED MODULE: ./src/frontmatter.ts
var frontmatter_assign = undefined && undefined.__assign || function () {
  frontmatter_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
      for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p)) t[p] = s[p];
    }
  ...
  return frontmatter_assign.apply(this, arguments);
};
...
var getBodyBegin = function getBodyBegin(content, matched) {
  var start = 1;
...
var frontmatter_parse = function parse(content, options) {
  ...
  var frontmatter = js_yaml.load(str, options);
  return {
 ...
 */
var extract = function extract(content, options) {
  if (options === void 0) {
    options = {};
  }
  var _options = frontmatter_assign({
    json: true
  }, options);
  var line = content.split(/(\r?\n)/)[0];
  if (line && /= yaml =|---/.test(line)) {
    return frontmatter_parse(content, _options);
  }
  return {
    frontmatter: {},
    body: content,
 ...
 */
var serialize = function serialize(object, options) {
  var _options = frontmatter_assign({
    skipInvalid: true
  }, options);
...
var NCache = /** @class */function () {
  function NCache(_a) {
    var _b = _a === void 0 ? {} : _a,
      _c = _b.maxCacheSize,
      maxCacheSize = _c === void 0 ? 10000 : _c,
      _d = _b.maxAge,
      maxAge = _d === void 0 ? 1000 * 60 * 60 * 24 * 30 : _d,
      _e = _b.debug,
  ...
  NCache.prototype.status = function (stringify) {
    ...
    return stringify ? "cache size: ".concat(this.cache.size, ", hit count: ").concat(this._hitCount, ", miss count: ").concat(this._missCount) : {
