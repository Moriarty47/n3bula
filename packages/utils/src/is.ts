...
export const isObject = (thing: unknown): thing is object =>
  !isNull(thing) && typeof thing === 'object';
...
export const isNullable = (thing: unknown): thing is null | undefined =>
  isNull(thing) || isUndefined(thing);
...
export const isDate = (thing: unknown): thing is Date =>
  isType<Date>(thing, 'date');

export const isRegExp = (thing: unknown): thing is RegExp =>
  isType<RegExp>(thing, 'regexp');
