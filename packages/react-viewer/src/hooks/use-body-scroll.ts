...
const useBodyScrollMock = (): [boolean, Dispatch<SetStateAction<boolean>>] => [false, ((t: boolean) => t) as Dispatch<SetStateAction<boolean>>];

export default isBrowser() ? useBodyScroll : useBodyScrollMock;
